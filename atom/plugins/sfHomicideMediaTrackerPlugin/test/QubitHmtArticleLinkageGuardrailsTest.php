...
define('HMT_TEST_VALID_ACTOR_ID', 7);
define('HMT_TEST_VALID_RECORD_ID', 42);

$actorExists = function ($id) {
    return HMT_TEST_VALID_ACTOR_ID === $id;
};

$recordExists = function ($id) {
    return HMT_TEST_VALID_RECORD_ID === $id;
};
...
$legacyAlias = QubitHmtArticle::diagnoseLinkage([
    'atom_object_id' => (string) HMT_TEST_VALID_RECORD_ID,
...
HmtLinkageGuardrailAssertions::assertSameValue(HMT_TEST_VALID_RECORD_ID, $legacyAlias['normalized']['atom_record_id'], 'Legacy atom_object_id should normalize to atom_record_id.');
HmtLinkageGuardrailAssertions::assertSameValue(HMT_TEST_VALID_RECORD_ID, $legacyAlias['normalized']['atom_object_id'], 'Legacy atom_object_id should be preserved after normalization.');
...
$mismatchedAlias = QubitHmtArticle::diagnoseLinkage([
    'atom_record_id' => (string) HMT_TEST_VALID_RECORD_ID,
    'atom_object_id' => '99',
], $actorExists, $recordExists);
